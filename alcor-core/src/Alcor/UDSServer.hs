...
{-| Implementation of the Alcor Unix Domain Socket JSON server interface.
...
import Alcor.Errors (AlcorException(..), ErrorResult)
import Alcor.JSON (fromJResult, fromJVal, fromJResultE, fromObj)
import Alcor.Logging
import Alcor.THH
import Alcor.Utils
import Alcor.Constants (privateParametersBlacklist)
...
type HandlerResult m o = m (Bool, GenericResult AlcorException o)
