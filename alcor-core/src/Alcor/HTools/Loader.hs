...
import qualified Alcor.HTools.Cluster.Moves as Moves

import Alcor.BasicTypes
import qualified Alcor.HTools.Tags as Tags
import qualified Alcor.HTools.Tags.Constants as TagsC
import Alcor.HTools.Types
import Alcor.Utils
import Alcor.Types (EvacMode, Hypervisor(..))

-- * Types

{-| The iallocator request type.

This type denotes what request we got from Alcor and also holds
...
-- | A complete request, as received from Alcor.
...
--
-- This examines the alcor:watcher:autorepair and
-- alcor:watcher:autorepair:suspend tags to determine the policy. If none of
...
updateMissing nl il static_node_mem =
    -- This overrides node mem on KVM as loaded from backend. Alcor 2.17
