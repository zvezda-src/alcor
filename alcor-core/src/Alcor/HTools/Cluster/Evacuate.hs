...
module Alcor.HTools.Cluster.Evacuate
  ( EvacSolution(..)
  , nodeEvacInstance
  , tryNodeEvac
  , emptyEvacSolution
...
import Alcor.HTools.Cluster.Metrics (compCVNodes)
import Alcor.HTools.Cluster.Moves (applyMoveEx)
import Alcor.HTools.Cluster.Utils ( splitCluster, iMoveToJob
