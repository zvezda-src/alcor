...
{-| TemplateHaskell helper for Alcor Haskell code.
...
import Alcor.JSON (readJSONWithDesc, fromObj, DictObject(..), ArrayObject(..),
...
import Alcor.THH.PyType
import Alcor.THH.Compat
...
-- | fromObj (Alcor specific) as an expression, for reuse.
fromObjE :: Q Exp
...
-- generic serialisation since we need to be compatible with Alcor's
