...
import Alcor.Errors (ErrorResult, ResultG)
import Alcor.JQueue.Lens (qoInputL, validOpCodeL)
import Alcor.JQueue.Objects
import Alcor.JSON (fromJResult, fromObjWithDefault)
import Alcor.Logging
import Alcor.Luxi
import Alcor.Objects (ConfigData, Node)
import Alcor.OpCodes
import Alcor.OpCodes.Lens (metaParamsL, opReasonL)
import Alcor.Path
import Alcor.Query.Exec as Exec
import Alcor.Rpc (executeRpcCall, ERpcError, logRpcErrors,
...
import Alcor.Utils.Livelock (Livelock, isDead)
import Alcor.Utils.MVarLock
import Alcor.VCluster (makeVirtualPath)
...
queueDirPermissions = FilePermissions { fpOwner = Just AlcorMasterd
