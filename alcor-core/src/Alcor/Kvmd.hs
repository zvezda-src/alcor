...
import qualified Alcor.BasicTypes as BasicTypes
import Alcor.Compat
import qualified Alcor.Constants as Constants
import qualified Alcor.Daemon as Daemon (getFQDN)
...
monitorDir :: String
monitorDir = AutoConf.localstatedir </> "run/alcor/kvm-hypervisor/ctrl/"
