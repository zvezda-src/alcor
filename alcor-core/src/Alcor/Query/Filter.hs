...
{-| Implementation of the Alcor Query2 filterning.
...
import Alcor.Utils.Monad (anyM, allM)
import Alcor.JSON (fromJVal)
...
-- | Operations in the leaves of the Alcor filter language.
