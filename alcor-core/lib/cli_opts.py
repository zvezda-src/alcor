...
"""Module containing Alcor's command line parsing options"""
...
COMPRESSION_TOOLS_OPT = \
    cli_option("--compression-tools",
               ...
               help="Comma-separated list of compression tools which are"
                    " allowed to be used by Alcor in various operations")
...
VERIFY_CLUTTER_OPT = cli_option(
    ...
    help="Verify that Alcor did not clutter"
...
SSH_KEY_TYPE_OPT = \
    cli_option("--ssh-key-type", default=None,
               ...
               help="Type of SSH key deployed by Alcor for cluster actions")

SSH_KEY_BITS_OPT = \
    cli_option("--ssh-key-bits", default=None,
               type="int", dest="ssh_key_bits",
               help="Length of SSH keys generated by Alcor, in bits")
